...
alpaca = api.REST('AK2F0129VO54AWW9R5X9', 'k0ZqFcZ0SJwHMFBdUm9XPH3k2WEMbG1Irh5hmOGD', 'https://api.alpaca.markets')
...
while True:
    ...
    Stock_List = ['NRGU','TQQQ','SQQQ','HIBS','HIBL','FNGU','FNGD','NRGU','NRGD','NUGT','DUST','FAS','FAZ','LABU','LABD','SOXL','SOXS','CURE','TMF','TMV','DFEN','WANT','DRV','DRN','SPY','QQQ','DIA','XLK','SOXX','XLE','XOP','XLY','IYR','XLB','XLU','XLP','XLF','SH','GDX','EFA']
                ...
                if b == 1:
                    if o == 1:
                        try:
                            ...
                            cash_to_spend = (account_cash / 1.1) * ((((Cash+Stock)-1700)/(volatility*100))/CST)
