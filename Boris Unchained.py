...
##############################################################
                common_length = min(len(K_), len(RSI_), len(OBV_), len(N_), len(SMMA_), len(Aroon_), len(MACD_), len(Fish_), len(Fish6_), len(Value3_) len(aaplv), len(aaplo), len(aaplc), len(aapll), len(aaplh))
                ...
                Fish6_array = np.array(Fish6_[-common_length:])
                ...
                feature_arrays = np.column_stack((K_array, RSI_array, OBV_array, N_array, SMMA_array, Aroon_array,
                                                  MACD_array,Fish_array, Fish6_array, Value3_array
                ...
                current_day_features = np.array([K_current, RSI_current, OBV_current, N_current, SMMA_current, Aroon_current,
                                          MACD_current, Fish_current, Fish6_current, Value3_array
                ...
                current_day_features = np.array([K_current, RSI_current, OBV_current, N_current, SMMA_current, Aroon_current,
                                          MACD_current, Fish_current, Fish6_current, Value3_current
                                          aaplv_current, aaplo_current, aaplc_current, aapll_current, aaplh_current])
