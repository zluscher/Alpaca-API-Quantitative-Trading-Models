...
alpaca = api.REST('AKD4OHIEV8PCWGE6SCD8', '14MGv6hn1It7hRboyrNk1rpOeKuJd4O3IetRU1cD', 'https://api.alpaca.markets')
...
while True:
    ...
    Stock_List = ['SPY','QQQ','DIA','XLK','SOXX','XLE','XOP','XLY','IYR','XLB','XLU','XLP','XLF','SH','GDX','EFA','HYG','TLT','PCY']
